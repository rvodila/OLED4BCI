...
function flicker_protocol_two_images_hybrid
    ...
    maxDisplaySec       = 10;             % total presentation time (s)
    ...
    codefile = fullfile(pwd, 'codes', 'mgold_61_6521.mat');
    S = load(codefile);
